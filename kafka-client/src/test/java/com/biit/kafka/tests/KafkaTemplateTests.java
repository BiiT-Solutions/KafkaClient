...
//    }
    ...
    public synchronized void produceMultipleEvents() {
        ...
        eventListener.addListener((event, offset, groupId, key, partition, topic, timeStamp) -> eventsReceived1.getAndIncrement());
        eventListener.addListener((event, offset, groupId, key, partition, topic, timeStamp) -> eventsReceived2.getAndIncrement());
